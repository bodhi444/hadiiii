...
/* ══════════════════════════════════════════
   ...
   Sherin Shahana & Riyas Hassan
   Wedding Reception: Saturday, 01 Aug 2026, 12:00 PM IST
══════════════════════════════════════════ */

// ── Wedding date target ────────────────────
const WEDDING_DATE = new Date('2026-08-01T12:00:00+05:30');
...
async function downloadWeddingCard(btn) {
  ...
  const FILENAME = 'Sherin-Riyas-WeddingCard.png';
  ...
  try {
    ...
    if (navigator.canShare && navigator.canShare({ files: [file] })) {
      await navigator.share({
        files: [file],
        title: 'Sherin Shahana & Riyas Hassan — Wedding Card',
        text:  'You\'re invited! ✨'
      });
    } else {
